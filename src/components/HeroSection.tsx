      ...
      <div className="container mx-auto px-4 relative z-10 py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          <div className="animate-fade-up order-2 lg:order-1">
            <h4 className="text-khan-gold font-semibold mb-3 uppercase tracking-wider">Salahuddin Khan</h4>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white leading-tight">
              Future Tycoon of <span className="gold-gradient-text">Nepal</span>
            </h1>
            <h2 className="text-xl md:text-2xl font-montserrat text-white/90 mb-4 flex items-center gap-2">
              <span>I am a </span>
          ...
          <div className="flex justify-center animate-fade-in order-1 lg:order-2">
            <div className="relative">
              <img 
                ...
                alt="Salahuddin Khan" 
                className="max-w-full h-auto rounded-[20px] border-4 border-khan-blue/30 shadow-lg shadow-khan-blue/30 animate-fade-in"
